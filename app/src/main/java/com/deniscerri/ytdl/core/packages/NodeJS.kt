...
object NodeJS : PackageBase() {
    override val executableName: String = "node"
    override val packageFolderName: String = "node"
    override val bundledZipName: String = "libnode.zip.so"
    ...
    override val githubPackageName: String  = "nodejs"
    override val apkPackage: String = "com.deniscerri.ytdl.nodejs"
